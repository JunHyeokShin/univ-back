...
public class EnrollmentRepositoryImpl implements EnrollmentRepository {
  ...
  public List<Enrollment> findByStudentIdAndSemester(Long studentId, String semester) {
    return this.jpaEnrollmentRepository.findByStudentIdAndSemester(studentId, semester);
  }

  @Override
  public List<Enrollment> findByCourseId(Long courseId) {
    return this.jpaEnrollmentRepository.findByCourseId(courseId);
  }

  @Override
  public List<Enrollment> findByStudentId(Long studentId) {
    return this.jpaEnrollmentRepository.findByStudentId(studentId);
  }
